...
class User(AbstractUser):
    ...
    linkedin = models.URLField(
        max_length=50, default="http://www.linkedin.com", blank=True, null=True
    )
...
class Event(models.Model):
    ...
    attendees = models.ManyToManyField(
        User, related_name="events_attending", through="EventAttendance", blank=True
    )
    points = models.IntegerField(
        default=10,
        validators=[MinValueValidator(10), MaxValueValidator(100), multiple_of_ten],
    )
