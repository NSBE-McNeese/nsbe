    ...
    <div className="info-page-container">
      ...
      <div className="stats-row">
        <div className="stat-card">
          ...
          <p className="stat-value" style={{ fontSize: "1.4rem" }}>nsbe@mcneese.edu</p>
        </div>
        <div className="stat-card" style={{ borderLeftColor: "#FFD700" }}>
          <h2>Chapter Dues</h2>
          <p className="stat-value" style={{ color: "#d4af37" }}>$McNeeseNSBE</p>
        </div>
      </div>
      ...
      <div className="content-split">
          ...
          <div className="step-list">
            <div className="step-item">
              ...
              <div className="step-content">
                ...
                <p>Always go to the <strong>Events Tab</strong> and click "Register" before the event starts. This creates your ticket.</p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                <h3>Get Your Code</h3>
                <p>Your unique QR code will appear in your dashboard. You can screenshot it or open it on your phone.</p>
              </div>
            </div>
            ...
            <div className="step-item">
              ...
              <div className="step-content">
                ...
                <p>Find the Membership Chair at the entrance. They will scan your phone, and points are added instantly!</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="side-column">
          <div className="side-header">
            <h2><VerifiedUserIcon /> Common Questions</h2>
          </div>
