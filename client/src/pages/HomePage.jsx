          ...
          <div className="content_container">
            <div className="content_left">
              <div>
                ...
                <p style={{ color: "rgb(157, 157, 157)" }}>
                  You are considered active in a week if you have either sent a
                  message or participated in NSBE concessions or activities.
                </p>
                  ...
                  <div>
                    ...
                    <ul>
                      <li style={{ color: "rgba(255, 0, 0, 0.795)" }}>
                        <p
                          style={{ fontSize: "large", textDecoration: "solid" }}
                        >
                          Inactive
                        </p>
                      </li>
              ...
              <span className="content_left_mid">
                <div>
                  ...
                  <h1 style={{ color: "rgb(10, 1, 18)" }}>
                    {pointsData.events_attended}
                  </h1>
                </div>
              ...
              <div className="content_left_mid_bottom">
                ...
                <p style={{ color: "rgb(157, 157, 157)" }}>
                  You are considered activated when you have completed the
                  following checklists.
                </p>
                <ul>
                  <li>
                    <p style={{ fontSize: "large", textDecoration: "solid" }}>
                      Inactive
                    </p>
                  </li>
                </ul>
            ...
            <div className="content_right">
              <div className="content_right_top">
                ...
                <a href="/path/to/nationalbylaws" target="_blank">
                  NSBE National Bye-Laws
                </a>
                <p style={{ color: "rgb(157, 157, 157)" }}>
                  A collection of resources.
                </p>

                <a href="/path/to/regionvbylaws" target="_blank">
                  RegionV Chapter Bye-Laws
                </a>
                <p style={{ color: "rgb(157, 157, 157)" }}>
                  A collection of resources.
                </p>
              ...
              <div style={{ height: "30%" }}>
                <h1 style={{ marginBottom: "15px", fontWeight: "500" }}>
                  Mission Statement
                </h1>
                <p
                  style={{
                ...
                >
                  ...
                  <span style={{ color: "black" }}>increase</span> the number of
